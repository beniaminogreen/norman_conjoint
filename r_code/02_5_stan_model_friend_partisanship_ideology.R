...
save(X,Z, file="../data/stan_draws/friend_partisanship_ideology_supp.Rda")
...
fit$save_object("../data/stan_draws/friend_partisanship_ideology_draws.Rda")
