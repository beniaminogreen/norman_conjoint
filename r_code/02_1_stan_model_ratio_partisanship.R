...
X <- model.matrix(~p_rep + p_dem + p_black + p_hispanic + p_asian + p_midwest + p_south + p_west + p_education + p_inc + p_female + p_jewish + p_muslim + p_atheist, data=data)
...
save(X,Z, file="../data/stan_draws/ratio_partisanship_supp.Rda")
...
fit$save_object("../data/stan_draws/ratio_partisanship_draws.Rda")
